...
public class MovieDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_POPULAR_MOVIES_TABLE = "CREATE TABLE " + MovieContract.MoviesSavedPopularity.TABLE_NAME + " (" +
                MovieContract.MoviesSavedPopularity._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                MovieContract.MoviesSavedPopularity.COLUMN_POSTER_PATH + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_ADULT + " BOOLEAN NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_OVERVIEW + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_RELEASE_DATE + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_MOVIE_ID + " INTEGER NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_ORIGINAL_TITLE + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_ORIGINAL_LANGUAGE + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_TITLE + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_BACKDROP_PATH + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_POPULARITY + " LONG NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_VOTE_COUNT + " INTEGER NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_VIDEO + " BOOLEAN NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_VOTE_AVERAGE + " DOUBLE NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_TRAILER + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_REVIEWS + " TEXT NOT NULL, " +
                MovieContract.MoviesSavedPopularity.COLUMN_FAV + " INTEGER NOT NULL DEFAULT 0);";
